...
use App\Http\Controllers\Api\V1\CustomerReservationPaymentController;
...
Route::post('/customer/reservations/{reference}/payment', [CustomerReservationPaymentController::class, 'store'])->middleware('throttle:20,1');
Route::get('/customer/reservations/{reference}/payment', [CustomerReservationPaymentController::class, 'show'])->middleware('throttle:60,1');
