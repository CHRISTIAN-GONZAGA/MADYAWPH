...
use App\Http\Controllers\Api\FrontDeskShiftController;
...
Route::get('/reports/frontdesk-sales/timed-in-summary', [ReportController::class, 'frontDeskTimedInSummary'])->middleware('role:admin,frontdesk');
...
Route::get('/frontdesk-shifts/active', [FrontDeskShiftController::class, 'active'])->middleware('role:admin,frontdesk');
Route::post('/frontdesk-shifts/start', [FrontDeskShiftController::class, 'start'])->middleware('role:frontdesk');
Route::post('/frontdesk-shifts/end', [FrontDeskShiftController::class, 'end'])->middleware('role:frontdesk');
