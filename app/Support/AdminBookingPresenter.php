...
final class AdminBookingPresenter
{
    ...
    public static function present(Booking $booking, ?Room $room = null): array
    {
        ...
        return [
            ...
            'is_org_booking' => (bool) ($booking->getAttributes()['is_org_booking'] ?? false)
                || SafeModelAttributes::rawString($booking, 'booking_source') === OrgBookingSupport::SOURCE,
            'org_name' => SafeModelAttributes::rawString($booking, 'org_name'),
            'org_type' => SafeModelAttributes::rawString($booking, 'org_type'),
            'org_contact_person' => SafeModelAttributes::rawString($booking, 'org_contact_person'),
            'org_contact_phone' => SafeModelAttributes::rawString($booking, 'org_contact_phone'),
            'org_contact_email' => SafeModelAttributes::rawString($booking, 'org_contact_email'),
            'org_address' => SafeModelAttributes::rawString($booking, 'org_address'),
            'org_tin' => SafeModelAttributes::rawString($booking, 'org_tin'),
            'org_po_number' => SafeModelAttributes::rawString($booking, 'org_po_number'),
