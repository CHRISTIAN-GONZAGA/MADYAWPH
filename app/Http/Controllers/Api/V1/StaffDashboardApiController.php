...
class StaffDashboardApiController extends Controller
{
    ...
    private function serializeTask(Task $task): array
    {
        return [
            ...
            'room_id' => SafeModelAttributes::rawString($task, 'room_id'),
            'task_type' => SafeModelAttributes::rawString($task, 'task_type') ?: 'general',
            'checklist' => is_array($task->checklist) ? $task->checklist : [],
            'status' => SafeModelAttributes::rawString($task, 'status'),
    ...
    private function serializeRoom(Room $room): array
    {
        return [
            ...
            'maintenance_reason' => SafeModelAttributes::rawString($room, 'maintenance_reason'),
