                ...
                <tr>
                    <td>
                        ...
                        <p style="margin:0 0 20px;font-size:15px;line-height:1.55;color:#4a5568;">
                            A guest was checked in at <strong>{{ $hotelName }}</strong> from the Book section.
                        </p>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="margin:0 0 20px;background:#eef2fa;border-radius:12px;border:1px solid #d6e4f7;">
                            <tr>
                                <td style="padding:16px 18px;">
                                    ...
                                    @endif
                                    @if($checkedInBy)
                                        <p style="margin:8px 0 0;font-size:13px;color:#4a5568;">Checked in by: {{ $checkedInBy }}</p>
                                    @endif
                                    @if($checkedInAt)
                                        <p style="margin:8px 0 0;font-size:13px;color:#4a5568;">Time: {{ $checkedInAt }}</p>
                                    @endif
                                </td>
                            </tr>
                        </table>
                        ...
                        <p style="margin:0;font-size:14px;line-height:1.5;color:#718096;">
                            This alert is sent to the hotel owner and the designated front desk Gmail.
                        </p>
                    </td>
                </tr>
            </table>
